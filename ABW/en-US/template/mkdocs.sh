...
AbiWord-2.0 --exp-props="html-template: $srcdir/template/template.html; href-prefix: ..; active-menu: interface; active-submenu: intdactivwin" \
	--to=$destdir/interface/dialogactivatewindow.html $srcdir/interface/dialogactivatewindow.abw
...
AbiWord-2.0 --exp-props="html-template: $srcdir/template/template.html; href-prefix: ..; active-menu: interface; active-submenu: intmweb" \
	--to=$destdir/interface/menuweb.html $srcdir/interface/menuweb.abw
...
AbiWord-2.0 --exp-props="html-template: $srcdir/template/template.html; href-prefix: ..; active-menu: problems; active-submenu: profonts" \
	--to=$destdir/problems/problemsfonts.html $srcdir/problems/problemsfonts.abw
